...
toc:
  ...
  - label: "2. Lancaster Archery"
    href: "#2-lancaster-archery"
  - label: "3. Hunting-Bow"
    href: "#3-hunting-bow"
  - label: "4. TenPoint Crossbows"
    href: "#4-tenpoint-crossbows"
  - label: "5. Bear Archery"
    href: "#5-bear-archery"
  - label: "6. Barnett Crossbows"
...
quickFacts:
  - value: "#1"
    label: "3Rivers Archery"
  - value: "#2"
    label: "Lancaster Archery"
  - value: "#3"
    label: "Hunting-Bow"
  - value: "#4"
    label: "TenPoint Crossbows"
  - value: "#5"
    label: "Bear Archery"
faq:
...
However, there's any section "customer reviews" to help you in your shopping decision.

Also, sometimes the site can be tricky.

Not all products can be bought on the website.

There's no clear distinction between the products sold online and the others.
...
On the online platform, there's a blog category.
...
However, there's no possibility of reading customers' feedbacks.
