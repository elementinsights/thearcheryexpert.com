...
toc:
  ...
  - label: "Multiple Facilities"
    href: "#multiple-facilities"
  - label: "Modern Developments"
    href: "#modern-developments"
  - label: "FAQ"
    href: "#faq"
...
## What Is Korean Archery And How Is It Different?

To have a better outlook on archery, one can't help but mention Korean archery and its difference.
...
Gakgung refers to the nation bow and is built with various materials. It's a water buffalo horn-based complex bow with its core made of bamboo.
...
It's also considered the Korean Army's secret weapon.

It's small in size and is fired through a Gakgung.

Due to its size, it's almost impossible for the enemies to reuse the same arrow and allow the Korean Army to buy time to deliver the next shot with no haste.
...
In most other countries, archers initially engage in archery in the form of recreation and later take it up as a serious sport, but it's of utmost importance in Korea.

There's a lot of pride and elegance within Korean Archery.
...
Most of the students are highly prepared for the sport since they're trained within the school itself.
...
They don't believe in private coaching for only the specifics.

It's a sport suitable for all.
...
Korean archery has been considered one of the most difficult sports. Along with its need to attain perfection, the training is longer and harder than any other participants in the world.
...
It's believed that the players throw a minimum of 100,000 arrows a year to represent themselves nationally.

Very few countable athletes train at this size outside of Korea.

Korean athletes are so efficient in their training that it's almost difficult to make a National team for their tournaments.
...
After the eight best archers are selected, they're further divided into two groups, A and B.
...
It's believed that archery equipment is very expensive.
...
It's taken seriously enough and is believed to have achieved a dedicated two hours each day in schools.

The general public can't have access to this game in the professional clubs.

It's solely made for tournament purposes and is considered as an Elite game.
...
It's believed that a good technique can be developed if the fundamental techniques are clear and understood.

There's a continuous practice that takes place where the trainer is made to bow without shooting.
...
It's the national representative body for archery in Korea.
