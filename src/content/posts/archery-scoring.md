...
description: "Learn how archery scoring works for both indoor and outdoor shooting, including WA and GNAS rules, target zones, scoring sheets, and tips for beginners."
category: "Knowledge"
postType: "guide"
...
toc:
  ...
  - label: "Types Of Archery Rounds And Their Uses"
    href: "#types-of-archery-rounds-and-their-uses"
  ...
  - label: "Additional Archery Facts"
    href: "#additional-archery-facts"
  - label: "FAQ"
    href: "#faq"
  - label: "Final Thoughts"
    href: "#final-thoughts"
faq:
  - question: "How many points is a bullseye worth in archery?"
    answer: "In a 10-zone target used in most competitions, hitting the innermost ring (the X-ring or inner gold) scores 10 points. In a 5-zone target used for imperial rounds, the gold center scores 9 points. The exact value depends on which scoring system your event follows."
  - question: "What's the difference between indoor and outdoor archery scoring?"
...
And before we begin, let's remind you that there are different archery scoring guides for shooting that are carried out in the great outdoors, while a separate archery scoring guide has been drafted for shooting in closed areas.
...
Build up your stamina. Ideally, you shouldn't get tired even after a set of 60-70 arrow throws.
...
Yet another archery scoring guide, but this time it's for the Imperial Rounds.
...
Depending on how good you're at it.
...
They're the large spectrum eyes for the archer, enabling them to aim and shoot at very accurate sites on the target round.
...
And another distinctive feature of it's its adjustability.
