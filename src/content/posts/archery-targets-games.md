...
toc:
  ...
  - label: "8. 3-D Archery"
    href: "#8-3-d-archery"
  - label: "9. 1-on-1 Olympic Target Archery"
    href: "#9-1-on-1-olympic-target-archery"
  - label: "10. Knockout"
    href: "#10-knockout"
  - label: "FAQ"
    href: "#faq"
...
Archery isn't an easy sport to get into as the archer needs to focus his attention, control his movements, and aim with precision during the game.
...
The only way you can sharpen these skills is if you practice the archery games that won't only enhance your sense of focus but will also make you go through the technical aspects of archery.
...
Gap shooting will enhance your distance skill and rely on eyeball because a sighting aid such as a telescope or rangefinder isn't permitted.
...
Once you've this set, your body is open and able to face the target at your comfortable angle.
...
You've to have a level of control where you choose to execute the shot and the number you pick in your head when to release.
...
Played solo or as a team for indoor target archery, you'll shoot 25 meters on a 60cm target and 18 meters on a 40cm target in a Recurve and Compound division.

If an arrow reaches outside the six rings, you'll score 0 because it misses the target.
