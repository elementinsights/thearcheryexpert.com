...
quickAnswer:
  label: "Quick Answer"
  title: "Archery Paper Tuning | 10-Step Guide To Paper Tune A Bow"
  text: "Start by building a simple paper frame, then shoot through it from 5-7 yards and read the tear pattern. A perfect tear looks like a clean bullet hole with three small fletching cuts -- anything else tells you exactly what adjustments to make."
toc:
  - label: "Step 1: Construct Your Frame"
    href: "#step-1-construct-your-frame"
  - label: "Step 2: Set Up The Paper In Frame"
    href: "#step-2-set-up-the-paper-in-frame"
  - label: "Step 3: Take The Right Bow And Arrow"
    href: "#step-3-take-the-right-bow-and-arrow"
  - label: "Step 4: Position Yourself"
    href: "#step-4-position-yourself"
  - label: "Step 5: Grip"
    href: "#step-5-grip"
  - label: "Step 6: Aim"
    href: "#step-6-aim"
  - label: "Step 7: Release Your Arrow"
    href: "#step-7-release-your-arrow"
  - label: "Step 8: Evaluate The Tears"
    href: "#step-8-evaluate-the-tears"
  - label: "Step 9: Adjust Your Bow If Necessary"
    href: "#step-9-adjust-your-bow-if-necessary"
  - label: "Step 10: Mistakes You Should Avoid"
    href: "#step-10-mistakes-you-should-avoid"
  - label: "FAQ"
    href: "#faq"
...
But don't worry, anyone can do it with the right knowledge and setup. Before you start tuning, make sure you've dialed in your [archery form](/archery-form/) and have a consistent [anchor point](/anchor-point-archery/) established.
...
Here's our 10-Step Guide To Paper Tune A Bow.
...
Use two eight-foot furring strips and a Sawzall to cut to length, A handheld drill and 1-inch drywall screws to create this simple frame.
...
If you're buying from a store, you must know that it's printed on the back of the arrow box and shows the spine or the shaft's stiffness.
...
If you've inconsistent flyers, place numbers or marks on each arrow to easily identify them.
...
You can minimize the distance gradually once you're sure that your tuning has completely done.

It's normal for beginners to feel tense the first few times, but I'd suggest that they try and focus on the target more.
...
This isn't at all how you look at word grip when it comes to archery.
...
Perhaps it's the most important task in all of the steps I've talked about.

You might face several scenarios like tail high, tail low, tail left or tail right, you can also experience multiple tears

All you've to do is to take a good shot through the suspended paper.
...
In this step, you'll adjust your bow, if necessary.

Your bow adjustments can take place by improving the rest to the left or right.

While doing the adjustments, make sure that you're chasing the point.

You'll have to rotate your rest to the left if the fletching is making a hole to the right and impacting on the left
