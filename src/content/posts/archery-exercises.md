...
toc:
  ...
  - label: "2. Distance Shooting"
    href: "#2-distance-shooting"
  - label: "3. Around the Clock"
  ...
  - label: "7. Count Down Drill"
    href: "#7-count-down-drill"
  - label: "8. Angle Drill"
    href: "#8-angle-drill"
  - label: "9. North-South-East-West"
    href: "#9-north-south-east-west"
  - label: "10. Focus Compass"
    href: "#10-focus-compass"
  - label: "FAQ"
    href: "#faq"
...
quickFacts:
  - value: "#1"
    label: "Blind Shooting"
  - value: "#2"
    label: "Distance Shooting"
  - value: "#3"
...
Just make sure you're facing your target as you feel the same anchor point with each shot released on the target.
...
You keep switching in the three target ranges, so you've an instinctual feel of the difference and how you may adjust your aim
...
This means you've a mental placement of the Clock’s number hands of 12, 3, 6, and 9 o’clock.

So you can choose if it’s 3 o’clock, then you've to aim at the right middle portion of the paper plate or round target.
...
Since your focus isn't on aiming but technique, you become more observant from the setup of the aim to the release of the arrow.
...
Once you take the shot, pay attention to your back tension if you've been opposing the hold of the bow upon release.
...
Your confidence is at an all-time high because the focus of the game isn't the aim but the technique and form.
...
If you can do this once a month, especially after a competition, you'll boost up the execution of the shot with proper coordination.
...
You’ll need to adapt your aim at a different angle since you're under time pressure, so you make that split-second decision and take the shot.
...
You become a flexible archer with different angles that you've to apply to the shot.
...
You start by making sure you've everything in place and are in the proper stance so that when your buddy starts counting, you're all set up.

Your buddy will call out a number from 1-20, while you're pulling the string from the bow and ready to release the arrow.
...
You've a few moments to set up your aim as you point the arrow to the target so make sure you hold steady until you’re ready to release.
...
Your aim works better in this situation because you're forced to wait for the number while you adjust to the nearest target.

You're aware of your anchor point, properly fixing the string as you take your aim while you wait for the golden number to be called.
...
It’s best to be cautious if you're on higher ground as there's a possibility of losing balance and falling.
...
Your goal isn't aimed at the center of the target, but around it where the impact point of your last arrow was shot.

So if the direction of the arrow ends up pointing to the south after impact on the target, that's where you take the next shot.
...
Your aiming skill is both challenged and sharpened because you've to aim outside of the center so you just used a different point.
...
If it lands too high or too low from the center target, then you've to focus on the anchor point.
...
Using this exercise is like a self-examination on your part of what you've to work on.
