...
toc:
  ...
  - label: "2. Archery's Move Named After Robin Hood"
    href: "#2-archerys-move-named-after-robin-hood"
  - label: "3. Arm Strength Required For Archery"
    href: "#3-arm-strength-required-for-archery"
  - label: "4. Archery As A Sport"
    href: "#4-archery-as-a-sport"
  - label: "5. Arrows Typically Do Not Kill The Target Immediately"
    href: "#5-arrows-typically-do-not-kill-the-target-immediately"
  - label: "6. British monarch's Obsession With Archery"
    href: "#6-british-monarchs-obsession-with-archery"
  - label: "7. Medieval Laws Linked To Archery"
    href: "#7-medieval-laws-linked-to-archery"
  - label: "8. Hunger Games Star Was Trained By Olympic Gold Medalist"
    href: "#8-hunger-games-star-was-trained-by-olympic-gold-medalist"
  - label: "9. Archery, Bhutan's National Sport"
    href: "#9-archery-bhutans-national-sport"
  - label: "10. Archers Still Have To Compete In The Rain"
    href: "#10-archers-still-have-to-compete-in-the-rain"
  - label: "FAQ"
    href: "#faq"
...
quickFacts:
  - value: "#1"
    label: "History Of Archery In Olympics"
  - value: "#2"
    label: "Archery's Move Named After Robin Hood"
  - value: "#3"
    label: "Arm Strength Required For Archery"
  - value: "#4"
    label: "Archery As A Sport"
  - value: "#5"
...
Once a player has hit the target in the center, there's still a remaining chance for the opponent to gain a tie.
...
If you don't have more strength than your bow, you're sure to get tired very quickly as you would be using all your strength just to pull it back.
...
Bearing in mind, they have to take into account the worst-case scenarios and include those that aren't fit enough to take part.
...
Well, unless they hit the heart or brain directly, they can't cause immediate death.
...
"We're celebrating the building of a new loo in the church. After all these years, we've at long last brought running water to the church," said Mary Edwards.
