...
quickAnswer:
  label: "Quick Answer"
  title: "How To Make Your Own DIY Foam Archery Targets | 10 Steps"
  text: "You can build a durable foam archery target for $30-$60 using interlocking puzzle mats, threaded rods, and basic hardware. The whole build takes about an hour, and you can swap out worn foam sections in minutes."
toc:
  ...
  - label: "Step 3: Building the Base for the Target"
    href: "#step-3-building-the-base-for-the-target"
  - label: "Step 4: Building the Top of the Target Base"
    href: "#step-4-building-the-top-of-the-target-base"
  - label: "Step 5: Secure the Threaded Rods"
    href: "#step-5-secure-the-threaded-rods"
  - label: "Step 6: Place the Foam into the Target Box"
    href: "#step-6-place-the-foam-into-the-target-box"
  - label: "Step 7: Secure and Compress the Foam"
    href: "#step-7-secure-and-compress-the-foam"
  - label: "Step 8: Add the Carpet Face on the Target Box"
    href: "#step-8-add-the-carpet-face-on-the-target-box"
  - label: "Step 9: Fix the Length of Threaded Rod"
    href: "#step-9-fix-the-length-of-threaded-rod"
  - label: "Step 10: Test your Archery Target Foam"
    href: "#step-10-test-your-archery-target-foam"
  - label: "FAQ"
    href: "#faq"
...
As you can see, there's so much that goes into shooting the bow and arrow, but for now, we'll focus on what you can do to improve your aim.

The fastest and easiest way to sharpen your aim is to have a target you can practice on as often as possible. If you'd rather buy a ready-made option, check out our roundups of the [best bag targets](/archery-bag-targets/) and [animal archery targets](/animal-archery-targets/).

That means you've your foam target box that you can easily transport or, better yet, have ready in your backyard. Setting up a [home archery range](/home-archery-range/) is the perfect complement to a homemade target.

Here's how to make your own DIY foam archery targets in ten steps.
...
## Step 2: Assembling the Foam

There's an easy and fast way to set up the foam, and there's a more tedious way that involves measurements.
...
Gather all the remaining pieces of the 2x4 wood, which is part of the material list, the two pieces of the 3'length and two pieces of the 1' length.

You'll use the 2x4 wood to shape a center rectangle using the four pieces put together.
...
Its weight will compress the foam into a solid base, so there's no space in-between the foam pieces.
...
## Step 6: Place the Foam into the Target Box

You'll now have all the foam with the cut part on the same side and facing the same way on top of each other like a stack.

You'll need to stack them up as high as 20" or almost two ruler lengths to make a 2'x3' target.

Remember that you'll need to rearrange this once the side facing target gets worn out from the arrow's many strikes.

As you do your practice, the arrow will hit different parts of the target, and the foam gets shot out.

At this point, you'll need to reshuffle the foam to put the worn-out ones on the very bottom or very top of the target.

If it's all shot out, then you'll dig into your new cut-up foam and replace the ones in the middle part area to have a solid center.

So best to have a whole set of puzzle foam or two sets ready to replace.

As you get better, you'll notice that your shot will concentrate on a spot, so this is where you'll need to move the new foam.
...
You can screw the nuts down the threaded rod then test it out by pulling it up once to make sure it's secured.
...
To tighten the nuts on each rod, use a spanner wrench, taking turns until it's snug and moving to the next one.
...
Although after using this a few times, you'll notice holes in the carpet, it serves as a protective layer to the foam.
...
## Step 9: Fix the Length of Threaded Rod
...
You'll need to cut off the 6' length ⅜" coarse threaded rod to measure 4' length because that's what's sold in the hardware.
...
Remember that you're working with a metal object, so you've to watch your hands and the edges while working.
