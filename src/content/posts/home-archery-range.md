...
toc:
  ...
  - label: "Safety is Paramount"
    href: "#safety-is-paramount"
  - label: "Check for Restrictions"
    href: "#check-for-restrictions"
  - label: "Range Layout"
    href: "#range-layout"
  - label: "Indoor or Basement Archery Range"
    href: "#indoor-or-basement-archery-range"
  - label: "Targets"
    href: "#targets"
  - label: "Backstops"
    href: "#backstops"
...
This can be the foremost essential arrow based weaponry target sort that each toxophilite or bowhunter has practiced with or purchased for themselves.
...
One restriction with this target is that it can be exceptionally troublesome to remove arrows.
...
This target sort is perfect for similar chasing recreations, and it will help you shoot at the shadow of your genuine target game animal, and this target sort is light to carry and set up for many shots down the extent or within the woods.
