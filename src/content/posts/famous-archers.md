...
toc:
  ...
  - label: "2. Darrel Pace - USA"
    href: "#2-darrel-pace-usa"
  - label: "3. Im Dong Hyun- Korea"
    href: "#3-im-dong-hyun-korea"
  - label: "4. Yun Mi-Jin - South Korea"
    href: "#4-yun-mi-jin-south-korea"
  - label: "5. Ki Bo Bae -  South Korea"
    href: "#5-ki-bo-bae-south-korea"
  - label: "6. Michele Frangelli - Italy"
    href: "#6-michele-frangelli-italy"
  - label: "7. Park Kyung-Mo - South Korea"
    href: "#7-park-kyung-mo-south-korea"
  - label: "8. Lee Sung Jin - South Korea"
    href: "#8-lee-sung-jin-south-korea"
  - label: "9. Howard Hill- USA"
    href: "#9-howard-hill-usa"
  - label: "10. Horace A. Ford - UK"
    href: "#10-horace-a-ford-uk"
  - label: "FAQ"
    href: "#faq"
...
quickFacts:
  - value: "#1"
    label: "Kim Soo Nyung - South Korea"
  - value: "#2"
    label: "Darrel Pace - USA"
  - value: "#3"
    label: "Im Dong Hyun- Korea"
  - value: "#4"
    label: "Yun Mi-Jin - South Korea"
  - value: "#5"
...
The preliminary ranking round determines the individual and team division's elimination round but isn't considered an official record.
